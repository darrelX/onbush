...
abstract class PdfRepository {
  ...
  Future<Either<DatabaseException, List<PdfFileEntity>>> getAllPdfFile({int maxResults = -1});
  ...
  Future<Either<DatabaseException, PdfFileEntity>> getPdfFileByPath({required String pdfPath});
